...
const customClientRouts = require("./routs/customClientRouts");
const subscriptionsRouts = require("./routs/subscriptionsRouts");
...
app.use("/api", customClientRouts);
app.use("/api", subscriptionsRouts);
